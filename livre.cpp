...
#include "livre.h"
using namespace std;
Livre::Livre(): titre_("Inconnu"), auteur_("Inconnu"), genre_("Inconnu"), langue("Inconnu"), datePublication_(), isbn_(0), nbExemplaires_(0) {}
Livre::Livre(const std::string& titre, const std::string& auteur,const std::string& genre ,const std::string& langue, const Date& datePublication, int isbn, int nbExemplaires)
